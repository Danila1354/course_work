...
int main(int argc, char *argv[]) {
    ...
    draw_hexagon(&image,62,109,900,918,"2.8.7",1,"8.60.106");
//    draw_rectangle(&image,110,51,322,258,23,"255.0.0",1,"0.255.0");
//    int colors[] = {255,0,0};
//    fill_cir2cle(&image,200,200,1,colors);
    write_png_file("/Users/danilapachev/Desktop/projects/course_work/output.png",&image);
////
